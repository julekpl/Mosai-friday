...
|---|---|---|---|---|
| U0 | Quick wins: resume last project, honest "not available yet" in Promote, plain-language copy | — | S | **done** (this PR) |
...
| U2 | Three-question wizard | — | M | not started |
| U3 | Starter-kit job (`starterKits` table, state machine, registry) | U2 · strategy Q2 for gating | L | not started |
| U4 | Kit screen on Home (three cards, five states, live region) | U3 | M | not started |
| U5 | Posts with pictures (owner photos, then Pexels with cache) | U3 · Q7 | M | not started |
| U6 | "This week" Home + outcome-ordered next step | U4 | M | not started |
| U7 | "Since you were away" | U6 | S | not started |
...
| U12 | Moderated usability test, 5 owners, after U4 | U4 | S | not started |
