...
with the V4 design. **Status words:** "code done" means merged-ready with its tests
passing in CI except the pre-existing full-history secret scan; it does not mean
proven with real owners (U12).

| ID | Ticket | Depends on | Size | Status |
|---|---|---|---|---|
| U0 | Quick wins: resume last project, honest "not available yet" in Promote, plain-language copy | — | S | **done**, PR #11 |
