...
| 12 | **BP-09/S2**† ContextPack/ContextInspector (finishes T0.4 → unblocks red test R4) | B | T2.10 | BP-09/S1 | implemented_unverified (server-owned bounded context and Build inspector in development main `f5a68aa`; social draft-variant follow-up locally integrated; reports: `docs/implementation/reports/BP-09-S2-context-pack.md`, `BP-09-S2-social-copilot.md`; 464 combined units/typecheck/build/audits and synthetic E2E 20+1 passed; Build chat, ads copilot, social scheduling, exact-commit CI for follow-up and external model proof remain open) |
...
| 43 | **BP-19** make the power understandable (usability) | E | T2.16 + design contracts | Orders A–D for the screens it touches; user-testing sessions (owner coordination) | in_progress (social connection gate source `eb39e27`; mobile navigation in development main `f5a68aa`; project Overview next-action/checklist locally integrated; reports: `docs/implementation/reports/BP-19-social-action-connection-gate.md`, `BP-19-mobile-navigation.md`, `BP-19-next-action.md`; public first-run preview audit: `docs/implementation/ux-audit-2026-09-24/`; authenticated mobile/Overview visual proof, reviewed-data transition and five observed user sessions remain open) |
