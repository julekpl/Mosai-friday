...
| 37 | **BP-17/S1** contact/import/consent | D | E3.3 | Order C | in_progress (bounded S1a contact CSV import and removal of unsupported consent-toggle claims; report: `docs/implementation/reports/BP-17-S1a-contact-import.md`; 473 combined units/typecheck/lint/build/auth/capability/data-registry audits passed locally; exact-SHA CI and real user journey remain open. Consent evidence ledger, withdrawal/suppression, legacy email dedupe and contact erasure remain open; no send capability.) |
