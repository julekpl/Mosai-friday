...
import { ArrowLeft, ArrowRight, CheckCircle2, Circle, FileText, Loader2 } from "lucide-react";
...
export function AppWorkspace({ build, onBack }: { build: Build; onBack: () => void }) {
  ...
  return <div>
    <ModuleHeader icon={Circle} title={`${build.name} · app brief`} subtitle="Describe the app, choose who it serves, and map the first things people need to do.">
    ...
    <div className="grid max-w-3xl gap-5">
      <div className="flex items-start gap-3 rounded-md border bg-card p-3 text-muted-foreground">
        ...
        <p className="font-mono text-caption">Build an app brief in a few steps. App generation and live preview aren’t available yet.</p>
      </div>
